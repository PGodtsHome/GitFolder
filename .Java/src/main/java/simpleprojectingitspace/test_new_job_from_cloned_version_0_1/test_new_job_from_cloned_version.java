...
package simpleprojectingitspace.test_new_job_from_cloned_version_0_1;
...
/**
 * Job: test_new_job_from_cloned_version Purpose: test_new_job_from_cloned_version<br>
 * Description: test_new_job_from_cloned_version <br>
 * @author user@talend.com
 * @version 6.0.1.20150908_1633
 * @status 
 */
public class test_new_job_from_cloned_version implements TalendJob {
	...
	private final String jobName = "test_new_job_from_cloned_version";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					test_new_job_from_cloned_version.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(test_new_job_from_cloned_version.this,
	...
	public static void main(String[] args) {
		final test_new_job_from_cloned_version test_new_job_from_cloned_versionClass = new test_new_job_from_cloned_version();

		int exitCode = test_new_job_from_cloned_versionClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = test_new_job_from_cloned_version.class
					.getClassLoader().getResourceAsStream(
							"simpleprojectingitspace/test_new_job_from_cloned_version_0_1/contexts/"
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : test_new_job_from_cloned_version");
		}
...
/************************************************************************************************
 * 22013 characters generated by Talend Open Studio for Data Integration on the
 * 16 mei 2017 18:54:44 CEST
 ************************************************************************************************/
